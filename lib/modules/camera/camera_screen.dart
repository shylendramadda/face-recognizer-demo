...
import 'package:fr_demo/modules/home/home_screen.dart';
...
class _CameraScreenState extends State<CameraScreen>
  ...
  getPermissionStatus() async {
    ...
    if (status.isGranted) {
      ...
      log('Camera Permission: New Request');
      if (newStatus.isDenied) {
        print('cam is Denied!');
      } else {
        print('cam is approved!');
      }
    }
  ...
  refreshAlreadyCapturedImages() async {
    ...
    if (fileNames.isNotEmpty) {
      ...
      if (recentFileName.contains('.mp4')) {
        ...
        filePath = _videoFile?.path.toString();
        _imageFile = null;
        _startVideoPlayer();
      } else {
        _imageFile = File('${directory.path}/$recentFileName');
        filePath = _imageFile?.path.toString();
        _videoFile = null;
      }
